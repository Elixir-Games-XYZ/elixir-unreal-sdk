...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Elixir",
		meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "OnComplete"))
	...
	UFUNCTION(BlueprintCallable, Category = "Elixir",
		meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "OnComplete"))
	static void QrVerify(UObject* WorldContextObject, FString QrValue, const FCallback& OnComplete);
};
